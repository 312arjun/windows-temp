...
func runAboutDialog(owner walk.Form) error {
	...
	showingAboutDialog.SetTitle(l18n.Sprintf("About Eclipz Agent"))
	...
	iv.MouseUp().Attach(func(x, y int, button walk.MouseButton) {
		if button == walk.LeftButton {
			win.ShellExecute(showingAboutDialog.Handle(), nil, windows.StringToUTF16Ptr("https://www.eclipz.com/"), nil, nil, win.SW_SHOWNORMAL)
	...
	iv.Accessibility().SetName(l18n.Sprintf("Eclipz logo image"))
	...
	copyrightLbl.SetText("Copyright ©") //Copyright © 2015-2022 Jason A. Donenfeld. All Rights Reserved.")
	...
	// 		easterEggIndex = 0
	// 	}
	// 	win.ShellExecute(showingAboutDialog.Handle(), nil, windows.StringToUTF16Ptr("https://www.eclipz.com/donations/"), nil, nil, win.SW_SHOWNORMAL)
